...
'voice', 'wednesday', 'weight','please wait for sometime','what is your mobile number','what are you doing','are you busy','show me a funny dance']
                ...
                while True:
                        ...
                        try:
                                ...
                                if(a.lower()=='goodbye'):
                                    ...
                                    lbl = ImageLabel(root)
                                    lbl.pack()
                                    lbl.load(r'c:\Users\Admin\Downloads\ISL_Gifs\{}.gif'.format(a.lower()))
                                    root.mainloop()
                                else:
                                    ...
                                    for i in range(len(a)):
                                                    if(a[i] in arr):
                                                            ...
                                                            ImageAddress = 'c:\\Users\\Admin\\Downloads\\letters\\asl\\'+a[i]+'.jpg'
...
while 1:
  image   = r'c:\Users\Admin\Downloads\signlang.png'
